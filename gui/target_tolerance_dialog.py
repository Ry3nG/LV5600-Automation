...
class TargetToleranceDialog(QDialog):
    ...
    def __init__(self, app_config):
        ...
        self.target_tolerance_spinbox.setRange(0.00, 1.00)
        self.target_tolerance_spinbox.setSingleStep(0.01)
        self.target_tolerance_spinbox.setValue(self.app_config.get_target_tolerance())
        self.target_tolerance_spinbox.setDecimals(2)
    ...
    def save_settings(self):
        # update app_config
        self.app_config.set_target_tolerance(self.target_tolerance_spinbox.value())
        self.app_config.set_flatness_check_pixel(self.flatness_check_pixel_spinbox.value())
        self.app_config.set_flatness_check_sv_threshold(self.flatness_check_sv_threshold_spinbox.value())
