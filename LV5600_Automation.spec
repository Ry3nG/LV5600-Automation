...
a = Analysis(['main.py'],
             ...
             datas=[('gui/resources/LV5600-Automation-OCB-Login-GUI.ui', 'resources'),
                    ('gui/resources/LV5600-Automation-OCB-GUI-2.0.ui', 'resources'),
...
exe = EXE(pyz,
          ...
          a.datas,
          [],
          name='LV5600-OCB-Automation-V2.2.1',
          debug=False,
